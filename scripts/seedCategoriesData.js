/**
 * Demo/Seed Data for Categories and Subcategories
 * 
 * This file contains sample data that can be used to populate the Category database.
 * You can use this data in the seed script or import it manually.
 */
...
const stats = {
  ...
  totalSubcategories: demoCategories.reduce(
    (sum, cat) => sum + cat.subcategories.length,
    0
  ),
  categoriesBySubcategoryCount: demoCategories.map((cat) => ({
    category: cat.category_display_name,
    subcategoryCount: cat.subcategories.length,
  })),
};

module.exports = { demoCategories, stats };

// If run directly, print the data structure
if (require.main === module) {
  console.log("Demo Categories Data Structure:\n");
  console.log(JSON.stringify(demoCategories, null, 2));
  console.log("\n\nStatistics:");
